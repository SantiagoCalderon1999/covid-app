...
function BasicTextFields() {
  ...
  const validateEmail = (email) => {
    return email.match(/^\w+@[a-zA-Z]+?\.[a-zA-Z]{2,3}$/);
  };
  const validate = () => {
    let temp = {};
    temp.email = inputs.email ? "" : "This field is required";
    temp.email = validateEmail(inputs.email)
      ? ""
      ...
      >
        <form>
            ...
            <DatePicker
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  onChange={handleChange}
                  error={
                    errors.birthdate !== "" && errors.birthdate !== undefined
                  }
          ...
          <TextField
            ...
            onChange={handleChange}
            error={
              errors.temperature !== "" && errors.temperature !== undefined
            }
